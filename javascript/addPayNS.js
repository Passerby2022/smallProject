$(function(){
    ...
    function getData(){
        $.ajax({
            ...
            success:function(res){
                ...
                //渲染成功
                if(res.status===0){
                    let contentStr = template("addPayNS",res);
                    //通过模板引擎将内容渲染到页面中
    ...
    function addPayNSData(ZnoData,DTData,IITData,NSData){
        $.ajax({
            method:'POST',
            url:'http://192.168.253.1:3000/api/addPayNS',
            data:{
                Zno:ZnoData,
                dt:DTData,
                iit:IITData,
    ...
    //监听添加按钮的点击事件
    $("#addPayNSData").on('click',debounce(function(){
