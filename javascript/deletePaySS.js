$(function(){
    ...
    function getData(){
        $.ajax({
            ...
            success:function(res){
                ...
                //渲染成功
                if(res.status===0){
                    let contentStr = template("deletePaySS",res);
                    //通过模板引擎将内容渲染到页面中
    ...
    function deletePaySSData(ZnoData){
        $.ajax({
            method:'POST',
            url:'http://192.168.253.1:3000/api/deletePaySS',
            data:{
                Zno:ZnoData
            },
            success:function(res){
    ...
    //监听添加按钮的点击事件
    $("#deletePaySSData").on('click',debounce(function(){
