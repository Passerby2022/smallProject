$(function(){
    ...
    function getData(){
        $.ajax({
            ...
            success:function(res){
                ...
                //渲染成功
                if(res.status===0){
                    let contentStr = template("addPaySS",res);
                    //通过模板引擎将内容渲染到页面中
    ...
    function addPaySSData(ZnoData,SubsidyData,DeductionData,InsureData,SSData){
        $.ajax({
            method:'POST',
            url:'http://192.168.253.1:3000/api/addPaySS',
            data:{
                Zno:ZnoData,
                Subsidy:SubsidyData,
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                if(res.status===0){
                    ...
                    addPaySSData(Zno,Subsidy,Deduction,Insure,ss);
                    //提交完数据后表单全部清空
                    clearText();
                }
            }
    ...
    //监听添加按钮的点击事件
    $("#addPaySSData").on('click',debounce(function(){
